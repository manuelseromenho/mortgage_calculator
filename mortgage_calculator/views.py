    ...
    def form_valid(self, form):
        ...
        if "totals" in self.request.POST:
            ...
            context = {
                ...
                "loan_interest": loan_interest,
                "payment_period": dict(form["payment_period"].field.choices).get(
                    form["payment_period"].data
                ),
            ...
            while (starting_balance - result) > 0:
                ...
                monthly_interest = starting_balance * (
                    percent_interest / payment_period
                )
                principal = result - monthly_interest
            ...
            return render(
                self.request, "mortgage_calculator/loan_amortization.html", context
            )
    ...
    def form_valid(self, form):
        if "totals" in self.request.POST:
            ...
            if account_created.calc_number_periodic_payments:
                ...
                return render(
                    self.request, "mortgage_calculator/mortgage_calc.html", context
                )
